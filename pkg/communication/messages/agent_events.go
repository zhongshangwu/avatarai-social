...
type InterruptEvent struct {
	AgentMessageID string `json:"agentMessageId"` // 响应ID
}
...
type ErrorEvent struct {
	...
	EventID string  `json:"eventId"` // 触发错误的事件ID
}

func (e *ErrorEvent) isChatEventBody() {}

type InProgressEvent struct {
	AgentMessage *AgentMessage `json:"agentMessage"` // 正在进行的响应
}

func (e *InProgressEvent) isChatEventBody() {}

type FailedEvent struct {
	AgentMessage *AgentMessage `json:"agentMessage"` // 失败的响应
}

func (e *FailedEvent) isChatEventBody() {}

type IncompleteEvent struct {
	AgentMessage *AgentMessage `json:"agentMessage"` // 不完整的响应
}
